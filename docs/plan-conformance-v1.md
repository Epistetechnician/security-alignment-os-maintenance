...
| 2. Evidence plane | `EvidenceRegistry` plus `artifacts::ArtifactManifest`, quarantine/accept/revoke lifecycle, canonical registry persistence/recovery, and exact subject/provenance binding | Partial; authenticated identities, custody verification/deletion, and public release packets remain open |
...
| 7. Governance | Local release state and digest-chained audit records | Partial; no authenticated release authority, recurring review, or public claim packet |
