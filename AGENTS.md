...
This repository is a local reference implementation of claim-bounded agent
security controls. Model output is proposal-only. No provider calls, model
...
`python3 -m compileall` before delivery.
